...
// Write a method to compute the result: 0=no ticket, 1=small ticket, 
// 2=big ticket. If speed is 60 or less, the result is 0. If speed is 
...
public class Question_05 {
	...
	public static void caughtSpeeding(int speed, boolean isBirthday) {
		...
		System.out.print("caughtSpeeding(" + speed + "," + isBirthday + ") -> ");
		if (isBirthday) {
			speed -=5;
		}
		if (speed <= 60) {
